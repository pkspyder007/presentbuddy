...
const electronAPI = {
  ...
  saveOriginalState: (state: OriginalState) =>
    ipcRenderer.invoke(IPC_CHANNELS.SAVE_ORIGINAL_STATE, state),
  getOriginalState: (): Promise<OriginalState> =>
    ipcRenderer.invoke(IPC_CHANNELS.GET_ORIGINAL_STATE),
